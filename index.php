...
<head>
    ...
    <title>V.BUILDCC DESIGN & CONSTRUCTION Co., LTD.</title>
...
<div id="hero-section" data-number="3" data-image-1="assets/img/slider/10.jpg" data-image-2="assets/img/slider/11.jpg" data-image-3="assets/img/slider/12.jpg" data-effect="fade">
    <div class="hero-content">
        ...
        <div class="hero-text">
            <p class="font-weight-600 letter-spacing-1px">
Architectural solutions, custom-fit for your <br> <span class="text-accent-color"> budget</span> and <span class="text-accent-color">Needs</span></p>
        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <h2 class="text-center  margin-bottom-10">FEATURED PROJECTS</h2>
                    ...
                    <section id="services-section" class="wprt-section services-2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="wprt-spacer" data-desktop="70" data-mobi="60" data-smobi="60"></div>
                                    <h2 class="text-center margin-bottom-10">OUR SERVICES</h2>
                                    <div class="wprt-lines style-2 custom-1">
                                        <div class="line-1"></div>
                                    </div>
